...
function onStepHit()
	...
	if curStep == 912 then
		...
		scaleObject('tmangstage', 3.0, 3.0);
		...
		if curStep == 928 then
			...
			doTweenY('dadTweenY', 'dad', -800, 2, 'cubeIn');
	
			end
	
			if curStep == 938 then
	
				doTweenY('dadTweenY', 'dad', 1100, 2, 'cubeIn');
		
				end
	
			if curStep == 928 then
	
				doTweenY('bfTweenY', 'boyfriend', 450, 2, 'cubeIn');
		
				end
	
				if curStep == 938 then
	
					doTweenY('bfTweenY', 'boyfriend', 900, 2, 'cubeIn');
			
					end

		if curStep == 1136 then

		doTweenY('dadTweenY', 'dad', 500, 2, 'cubeIn');
